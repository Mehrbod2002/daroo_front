    ...
    request.onloadend = function () {
      if (request.status == 200 || request.status == 201) {
        ...
        for (const el of reception) {
          el.addEventListener("click", function () {
            window.location.href = `http://127.0.0.1:5502/main-reception-requests.html?centerid=${el.getAttribute(
              "id"
            )}`;
          });
        }
        ...
        for (const el of transaction) {
          el.addEventListener("click", function () {
            window.location.href = `http://127.0.0.1:5502/main-reports.html?centerid=${el.getAttribute(
              "id"
            )}`;
          });
        }
        ...
        for (const el of wallet) {
          el.addEventListener("click", function () {
            window.location.href = `http://127.0.0.1:5502/main-wallet.html?centerid=${el.getAttribute(
              "id"
            )}`;
          });
        }
        ...
        for (const el of profile) {
          el.addEventListener("click", function () {
            window.location.href = `http://127.0.0.1:5502/main-profile.html?centerid=${el.getAttribute(
              "id"
            )}`;
          });
        }
